		...
		<div class="product-main">
			  ...
			  <div class="col-md-9 product-block">
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h28.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h29.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			     ...
			     <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h30.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h31.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h32.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h33.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h34.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h35.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.jsp"><img src="images/h36.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.jsp">Smart Shopping</a></h3>
								<p>Explore Now</p>						
